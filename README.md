...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&pause=1000&color=00FF41&background=00000000&center=true&vCenter=true&width=700&lines=root%40hiru%3A~%24+sudo+access+devops-mainframe;%5BOK%5D+Docker+container+initialized;%5BOK%5D+Terraform+apply+--auto-approve;%5BOK%5D+Deploying+to+AWS+%2F+Azure...;connection+established+%E2%9C%93+open+to+internships" alt="Terminal Typing SVG" />
</p>
...
> 🐍 **Want an animated snake eating your contribution graph?**
> It needs a tiny one-time setup since it's generated by a GitHub Action in *your own* repo, not a plug-in-your-username link:
> 1. In your profile repo (`YOUR_USERNAME/YOUR_USERNAME`), go to **Actions** → new workflow
> 2. Use the template from [Platane/snk](https://github.com/Platane/snk) — copy their sample `snake.yml` workflow
> 3. Push it, let the Action run once (builds an `output` branch with your real snake SVG)
> 4. Replace the image line above with: `https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_USERNAME/output/github-contribution-grid-snake.svg`
